...
<!--button css-->
<link href="{{ asset('admin/css/demo-page.css') }}" rel="stylesheet" media="all">
<link href="{{ asset('admin/css/hover.css') }}" rel="stylesheet" media="all">
<!--//but-->
</head>
<body>	
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="index.blade.php"> <h1>Shoppy</h1> 
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="{{ asset('admin/images/p6.png') }}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="{{ asset('admin/images/p7.png') }}" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="index.blade.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Components</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="grids.blade.php">Grids</a></li>
		            <li><a href="portlet.blade.php">Portlets</a></li>		            
		          </ul>
		        </li>
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Element</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		            <li id="menu-mensagens" style="width: 120px" ><a href="buttons.blade.php">Buttons</a>		              
		            </li>
		            <li id="menu-arquivos" ><a href="typography.blade.php">Typography</a></li>
		             <li id="menu-arquivos" ><a href="icons.blade.php">Icons</a></li>
		          </ul>
		        </li>
		          <li><a href="maps.blade.php"><i class="fa fa-map-marker"></i><span>Maps</span></a></li>
		        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Pages</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-academico-sub" >
		          	 <li id="menu-academico-boletim" ><a href="login.blade.php">Login</a></li>
		            <li id="menu-academico-avaliacoes" ><a href="signup.blade.php">Sign Up</a></li>		           
		          </ul>
		        </li>
		        
		        <li><a href="charts.blade.php"><i class="fa fa-bar-chart"></i><span>Charts</span></a></li>
		        <li><a href="#"><i class="fa fa-envelope"></i><span>Mailbox</span><span class="fa fa-angle-right" style="float: right"></span></a>
		        	 <ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="inbox.blade.php">Inbox</a></li>
			            <li id="menu-academico-boletim" ><a href="inbox-details.blade.php">Compose email</a></li>
		             </ul>
		        </li>
		         <li><a href="#"><i class="fa fa-cog"></i><span>System</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="404.blade.php">404</a></li>
			            <li id="menu-academico-boletim" ><a href="blank.blade.php">Blank</a></li>
		             </ul>
		         </li>
		         <li><a href="#"><i class="fa fa-shopping-cart"></i><span>E-Commerce</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	<ul id="menu-academico-sub" >
			            <li id="menu-academico-avaliacoes" ><a href="product.blade.php">Product</a></li>
			            <li id="menu-academico-boletim" ><a href="price.blade.php">Price</a></li>
		             </ul>
		         </li>
		      </ul>
		    </div>
