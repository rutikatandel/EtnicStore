...
<body>
				...
				<div class="header-right">
						<div class="cart box_1">
							<a href="checkout.html">
								<h3> <span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)<img src="{{ asset('user/images/bag.png') }}" alt=""></h3>
							</a>	
	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="{{ asset('user/images/l4.jpg') }}" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="images/si.jpg">
								<div class="thumb-image"> <img src="{{ asset('user/images/si.jpg') }}" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/si1.jpg">
								<div class="thumb-image"> <img src="{{ asset('user/images/si1.jpg') }}" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="images/si2.jpg">
							<div class="thumb-image"> <img src="{{ asset('user/images/si2.jpg') }}" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="{{ asset('user/images/icon1.png') }}" alt="" />
								</a>
 ...
 <script src="{{ asset('user/js/responsive-tabs.js') }}"></script>
